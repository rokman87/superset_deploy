...
REDIS_WEBSOCKET_DB = os.getenv("REDIS_WEBSOCKET_DB", "2")  # Добавлено для WebSocket
...
GLOBAL_ASYNC_QUERIES_JWT_SECRET = os.getenv(
    ...
    "CHANGE_ME_TO_A_COMPLEX_SECRET_AT_LEAST_32_CHARS"
)
GLOBAL_ASYNC_QUERIES_JWT_COOKIE_NAME = "async-token"
GLOBAL_ASYNC_QUERIES_JWT_COOKIE_SECURE = False  # True для HTTPS
GLOBAL_ASYNC_QUERIES_JWT_COOKIE_SAMESITE = "Lax"
GLOBAL_ASYNC_QUERIES_JWT_COOKIE_DOMAIN = None

# Настройки Redis для асинхронных запросов
GLOBAL_ASYNC_QUERIES_REDIS_CONFIG = {
    "host": REDIS_HOST,
    "port": int(REDIS_PORT),
    "db": int(REDIS_WEBSOCKET_DB),  # Используем отдельную БД для WebSocket
    "password": "",
    "ssl": False,
}

# Настройки для асинхронных запросов
GLOBAL_ASYNC_QUERIES_MAX_ATTEMPTS = 5
GLOBAL_ASYNC_QUERIES_POLL_INTERVAL = 500  # миллисекунды

# Настройки для отчетов и оповещений
